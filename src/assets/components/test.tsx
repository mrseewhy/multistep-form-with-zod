...
// const web_types = ['Landing Page', 'Marketing Site', 'Ecommerce', 'Blog']
...
//     companySize: z.enum(sizedata, 'Invalid option, please select a valid one from the options above!').optional().nullable(),
//     help: z.array(z.string()).min(1, 'Error! select an item'),
//     websitetype: z.enum(web_types, 'Please select website type').optional(),
//     roleCount: z.number('Please enter a valid number').gte(1, 'Number must be 1 ore more').optional().nullable(),
//     authRequired: z.enum(['yes', 'no'], 'Please select an option').optional().nullable(),
// })
...
// //             });
// //         }
// //         const selectedWebsite = data.help.includes('website');

// //         if (selectedWebsite && !data.websiteType) {
// //             ctx.addIssue({
// //                 path: ['websiteType'],
// //                 code: z.ZodIssueCode.custom,
// //                 message: 'Please select website type',
// //             });
// //         }
...
//     React.useEffect(() => {
//         if (!help) return
//         if (!help.includes('mobile app') || !help.includes('web app')) {
